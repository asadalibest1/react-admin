...
import WebsiteErrTable from "./Tables/WebsiteErr";
// import * as $ from "jquery";
// import noImagePreview from "../../img/noImagePreview.png"

export default function WebsiteErrReports() {
    ...
    <div>
      ...
      <div class="container-fluid">
        ...
        <div className="col-md-11">
            <h1 class="h3 mb-2 text-gray-800">Website Error Reports</h1>
            <h6>Website Error Reports</h6>
        </div>
        ...
        {/* <div className="col-md-12 text-right px-4">
            ...
            >
              ...
              <span class="text pl-1">Reports</span>
            </a>
          </div> */}
