...
export default function CustomersAction() {
    ...
    return (
        ...
        <SweetAlert
            ...
            onConfirm={(response)=> console.log(response)}
            title="Are you sure?"
                ...
                <div class="modal-dialog modal-center modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body row pt-5">
                            ...
                            <div class="form-group col-md-6">
                                <input type="email" class="form-control bg-white" disabled placeholder="Enter Email" />
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <input type="password" class="form-control bg-white" disabled placeholder="Enter password" />
                            </div>
                            <div class="col-md-2 p-0 m-0 c-hover">
                                <div class="hover-btn">
                            ...
                            <div class="form-group col-md-6">
                                <input type="number" class="form-control bg-white" disabled placeholder="+92123567890" />
                            </div>
                            <div class="col-md-2 p-0 m-0 c-hover">
                                <button type="button" class="btn btn-outline-info hover-btn">
                                    <i class="fa fa-clone" aria-hidden="true"></i>
                            ...
                            <div class="form-group col-md-6">
                                <input type="number" class="form-control bg-white" disabled placeholder="192.168. 0.1" />
                            </div>
                            <div class="col-md-2 p-0 m-0 c-hover">
                                <button type="button" class="btn btn-outline-info hover-btn">
                                    <i class="fa fa-clone" aria-hidden="true"></i>
                            ...
                            <div class="form-group col-md-6">
                                <textarea class="form-control bg-white" aria-label="With textarea" value="New York, United States of America." disabled></textarea>
                            </div>
                            <div class="col-md-2 p-0 m-0 c-hover">
                                <button type="button" class="btn btn-outline-info hover-btn">
                                    <i class="fa fa-clone" aria-hidden="true"></i>
